...
export const SERVER = Object({
	...
	CREATE_AUTH_TOKEN:"admin-auth-token",
	VERIFY_AUTH_TOKEN:"verify-auth-token",
	PROVIDER_PROFILE:"provider/profile",
	SEND_INVITE: "provider/resend-invite",
	TICKET_LISTING: "provider/ticket-listing",
	TICKET_DETAILS: "provider/ticket",
	TICKET_STATUS: "provider/ticket",
	BLOCK_UNBLOCK_PROVIDER: "provider/block-unblock",
	CREATE_PROVIDER:"provider",
	GET_PROVIDERS: "provider",
	SEARCH_CLINIC: "provider/search-clinic",
	SEARCH_PROVIDER: "provider/search-provider",
	GET_PATIENTS: "patient/all-patients",
	PATIENT_PROFILE: "patient/profile",
	RESET_PASSWORD: "patient/reset-password",
	BLOCK_PATIENT: "patient/block",
	VERIFY_VERIFICATION_TOKEN:"verify-verification-token",
	GET_SUBSCRIPTION: "provider/subscriptions",
	SUBSCRIPTION: "provider/subscription",
	TRANSACTIONS: "order/transactions",
	ALL_TRANSACTIONS: "order/all-transactions",
	AMOUNT_LOG: "order/amount-log",
	SUBSCRIPTION_DETAILS: "provider/subscription-details",
	SEND_MAIL: "notification/email-template",
	SEND_NOTIFICATION_TO_WEB: "provider/notification",
	SEND_NOTIFICATION_TO_APP: "patient/notification",
	SEND_NOTIFICATION: "notification/send",
	NOTIFICATION_APP_URL: process.env["NOTIFICATION_APP_URL"],
	PROVIDER_APP_URL: process.env["PROVIDER_APP_URL"],
	...
	EDIT_CLINIC: "provider/clinic",
	PATIENT_GLUCOSE_DATA: "patient/glucose-history",
	PATIENT_RPM_DATA: "provider/rpm-history",
	MONGO: {
	...
	SECRET_MANAGER_KEY: process.env["SECRET_MANAGER_KEY"]
});