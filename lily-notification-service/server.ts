...
class App {
  ...
  private async startapp() {
    fetchSecrets().then(async () => {
      this.template();
      this.Port = process.env.NOTIFICATION_PORT;
  ...
  private callback = () => {
    logger.info(` Hapi server swagger is running this URL :- ${SERVER.APP_URL}/${SERVER.NOTIFICATION_MICROSERVICE_URL}/documentation`);
