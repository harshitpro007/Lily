  ...
  class App {
    ...
    private async startapp() {
      fetchSecrets().then(async () => {
        this.template();
        this.Port = (process.env.ORDER_PORT);
    ...
    private callback = () => {
      logger.info(` Hapi server swagger is running this URL :- ${SERVER.APP_URL}:${SERVER.ORDER_PORT}/${SERVER.ORDER_MICROSERVICE_URL}/documentation`);
