...
import { fetchSecrets } from "@utils/secretManger";
  ...
  class App {
    ...
    private async startapp() {
      ...
      this.template();
      this.Port = process.env.PATIENT_PORT;
    ...
    private callback = () => {
      logger.info(` Hapi server swagger is running this URL :- ${SERVER.APP_URL}:${SERVER.PATIENT_PORT}/${SERVER.PATIENT_MICROSERVICE_URL}/documentation`);
