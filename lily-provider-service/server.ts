...
import { fetchSecrets } from "@utils/secretManger";
  ...
  class App {
    ...
    private async startapp() {
      ...
      this.template();
      this.Port = (process.env.PROVIDER_PORT);
    ...
    private callback = () => {
      logger.info(` Hapi server swagger is running this URL :- ${SERVER.APP_URL}:${SERVER.PROVIDER_PORT}/${SERVER.PROVIDER_MICROSERVICE_URL}/documentation`);
